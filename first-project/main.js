...
//     }
// });
/* Hệ thống phản ứng REACTIVITY giúp chúng ta giám sát các thuộc tính 
trong data của vueInstance nếu như có sự thay đổi nào 
của data nó sẽ tự render ra trang web của chúng ta 
*/
/* Để thay đổi biến dữ liệu trong data ở một nơi khác thì ta sử dụng vueInstance.title =>  vueInstance.title = "IloveU" */
var vueInstance = new Vue({
  el: "#app",
  data: {
    title: "Áo thun nam thể thao hàng VNXK vải dày mịn - Vải Đốm",
